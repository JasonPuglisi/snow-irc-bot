									...
									if (commentExists) {
										...
										for (var k = 0; k < users.length; k++) {
											...
											if (!nameGeneric && userMentioned)
												client.say(mainChannel, users[k] + ': You were mentioned in a post at https://boards.4chan.org/' + config.thread.board + '/thread/' + threadId + '#p' + postId);
										}
									}
